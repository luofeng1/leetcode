...
- [x] [206.反转链表](https://leetcode-cn.com/problems/reverse-linked-list) [golang-code](./206-reverse-linked-list.go) [解析](https://github.com/azl397985856/leetcode/blob/master/problems/206.reverse-linked-list.md)
...
* [leetcode字节跳动题库]
    * `select * from "题库" where "难度" = '中等' order by "出题指数" desc limit 50;`
        - 动态规划
        ...
        - 树,深度优先搜索,广度优先搜索
            ...
            * [x] 394. 字符串解码 [golang-code](./394-decode-string.go) [`深度优先搜索`] [`栈`]
